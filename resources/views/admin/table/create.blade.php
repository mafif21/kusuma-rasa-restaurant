      ...
      <div class="border border-gray-200 shadow-md w-9/12 p-20 rounded-lg">
        ...
        <form method="post" action="{{ route('admin.table.store') }}">
          ...
          <div class="mb-6">
            ...
            <input type="text" id="capacity" name="guest_number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-3 " placeholder="menu price" value="{{ old('price') }}">
