      ...
      <div class="border border-gray-200 shadow-md w-9/12 p-20 rounded-lg">
        ...
        <form method="post" action="{{ route('admin.category.store') }}" enctype="multipart/form-data">
          ...
          <div class="mb-6">
            ...
            <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3 " placeholder="category name" value="{{ old('name') }}">
          ...
          <div class="mb-6">
            ...
            <textarea id="message" name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Category Description">{{ old('description') }}</textarea>
