    ...
    <div class="flex justify-between mb-5 items-center">
        <div class="relative">
            <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                ...
                <input type="text" id="table-search" class="block p-3 pl-10 w-80 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-orange-200 focus:border-orange-200 border-gray-100 placeholder-gray-400 " placeholder="Search for items">
        </div>
        <div>
